...
<head>
    ...
    <style type="text/css">
        @media print {.gm-style .gmnoprint, .gmnoprint {
                display:none}
        }
        @media screen {.gm-style .gmnoscreen, .gmnoscreen {
            display:none }
        }
    </style>
    <style type="text/css">
    ...
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/common.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/map.js"></script>
    <style type="text/css">.gm-style {
            font: 400 11px Roboto, Arial, sans-serif;
            text-decoration: none;
        }
        .gm-style img { max-width: none; }</style>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/util.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/onion.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/controls.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/marker.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/infowindow.js"></script>
    <script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/31/8a/intl/th_ALL/stats.js"></script>
</head>
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a class="dropdown-item" href="#" id="stationB1">รถบัส</a></li>
                <li><a class="dropdown-item" href="#" id="stationB2">รถแดง</a></li>
                <li><a class="dropdown-item" href="#" id="stationB2">รถตุ๊กๆ</a></li>
            </ul>
        </div>
        <div class="card-body">
            <div class="embed-responsive embed-responsive-16by9">
                <div id="map" class="embed-responsive-item" style="overflow: hidden;">
                    <div style="height: 100%; width: 100%; position: absolute; top: 0px; left: 0px; background-color: rgb(229, 227, 223);">
                        <div class="gm-style" style="position:absolute;z-index: 0;left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px;
                        border-width: 0px; margin: 0px;">
                            <div tabindex="0" style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px;
                            border-width: 0px; margin: 0px; cursor: url(&quot;https://maps.gstatic.com/mapfiles/openhand_8_8.cur&quot;) 8 8, default;">
                                <div style="z-index: 1; position: absolute; top: 0px; left: 0px; width: 100%; transform-origin: 0px 0px 0px;
                                transform: matrix(1, 0, 0, 1, 0, 0);"><div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                                        <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                            <div aria-hidden="true" style="position: absolute; left: 0px; top: 0px; z-index: 1; visibility: inherit;">
                                                <div style="width: 256px; height: 256px; position: absolute; left: -6px; top: -82px;"></div>
                                                <div style="width: 256px; height: 256px; position: absolute; left: 250px; top: -82px;"></div>
                                                <div style="width: 256px; height: 256px; position: absolute; left: 250px; top: 174px;"></div>
                                                <div style="width: 256px; height: 256px; position: absolute; left: -6px; top: 174px;"></div>
                                                <div style="width: 256px; height: 256px; position: absolute; left: 506px; top: -82px;"></div>
                                                <div style="width: 256px; height: 256px; position: absolute; left: 506px; top: 174px;"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
                                        <div style="position: absolute; left: 0px; top: 0px; z-index: -1;">
                                            <div aria-hidden="true" style="position: absolute; left: 0px; top: 0px; z-index: 1; visibility: inherit;">
                                                <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: -6px; top: -82px;"></div>
                                                <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 250px; top: -82px;"></div>
                                                <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 250px; top: 174px;"></div>
                                                <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: -6px; top: 174px;"></div>
                                                <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 506px; top: -82px;"></div>
                                                <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 506px; top: 174px;"></div>
                                            </div>
                                        </div>
                                        <div style="width: 20px; height: 24px; position: absolute; left: 1285px; top: -205px; z-index: -202;">
                                            <canvas width="22" height="26" draggable="false" style="width: 20px; height: 24px; position: absolute; left: 0px;
                                            top: 0px; user-select: none;">
                                            </canvas>
                                        </div>
                                        <div style="width: 29px; height: 26px; position: absolute; left: 166px; top: 196px; z-index: 206;">
                                            <canvas width="31" height="28" draggable="false" style="width: 29px; height: 26px; position: absolute; left: 0px;
                                            top: 0px; user-select: none;">
                                            </canvas>
                                        </div>
                                        <div style="width: 24px; height: 20px; position: absolute; left: 677px;top: 135px; z-index: 145;">
                                            <canvas width="26" height="22" draggable="false" style="width: 24px; height: 20px; position: absolute; left: 0px;
                                            top: 0px; user-select: none;">
                                            </canvas>
                                        </div>
                                        <div style="width: 29px; height: 30px; position: absolute; left: 1271px; top: -203px; z-index: -195;">
